...
<x-app-layout>
                            ...
                            @foreach($users as $user)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="border-t p-4 text-center flex justify-center space-x-2">
                                        <button class="bg-yellow-500 text-white p-2 rounded flex items-center"
    ...
    <div id="userModal"
        class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 transition-opacity duration-300 ease-in-out hidden">
        <div
            class="bg-white p-4 md:p-6 rounded-2xl shadow-2xl transform transition-transform duration-300 ease-in-out w-full max-w-md max-h-[80%] relative overflow-auto">
            <button type="button" onclick="closeModal()"
                class="absolute top-4 right-4 text-gray-700 hover:text-gray-900 transition duration-200">
            ...
            <form id="userForm" action="{{ route('users.store') }}" method="POST">
                ...
                <input type="text" id="name" name="name" pattern="[A-Za-z\s]{2,50}" maxlength="25"
                    title="Solo letras, mínimo 2 caracteres y máximo 50"
                    class="border border-gray-300 p-3 w-full mb-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required>

                <label for="apellido" class="block mb-2 text-gray-700">Apellido:</label>
                <input type="text" id="apellido" name="apellido" pattern="[A-Za-z\s]{2,50}" maxlength="25"
                    title="Solo letras, mínimo 2 caracteres y máximo 50"
                    class="border border-gray-300 p-3 w-full mb-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required>
                    <label for="email" class="block mb-2 text-gray-700">Correo:</label>
<input type="email" id="email" name="email" pattern="^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.com$"
    title="Ingresa un correo válido que termine en .com"
    class="border border-gray-300 p-3 w-full mb-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
    required>
                ...
                <input type="password" id="password" name="password" minlength="8"
                    ...
                    title="Mínimo 8 caracteres, al menos un número y una letra"
                    class="border border-gray-300 p-3 w-full mb-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required>

                <div class="flex justify-between">
                    <button id="submitButton" type="submit"
                        class="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center transition-colors duration-200 hover:bg-blue-500">
    ...
    <div id="editUserModal"
        ...
        <div
            ...
            <form id="editUserForm" action="{{ route('users.update', ':id') }}" method="POST">
                ...
                <div class="flex justify-between">
                    <button id="editSubmitButton" type="submit"
                        class="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center transition-colors duration-200 hover:bg-blue-500">
